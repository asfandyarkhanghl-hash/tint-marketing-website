...
const testimonials = [
  { name: 'Marcus T.', location: 'Phoenix, AZ', text: "I've worked with agencies before. None of them understood window tinting. Tint Marketing Pro knew exactly what keywords our customers use, what makes them click, and how to convert them." },
  { name: 'Sandra R.', location: 'Dallas, TX', text: "They promised results fast. Leads started coming in the first week. The follow-up automation alone is worth the price." },
  { name: 'James K.', location: 'Miami, FL', text: "I went from invisible on Google Maps to ranking in my city's top 3. My schedule is a lot fuller than it used to be." },
...
export default function TestimonialCarousel() {
  ...
  return (
    <section className="py-24 section-dark overflow-hidden">
      ...
      <p className="text-center text-slate-500 text-xs uppercase tracking-widest mb-12">Representative feedback from tint shop clients</p>
